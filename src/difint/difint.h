...
// okay... i tried to use variadic but failed - VS builder 17.1
// And by some reason, the cascading way does not work, the last resord is below...
...
#define DIFINT_VAR_7(v1, v2, v3, v4, v5, v6, v7, v8) \
DIFINT_VAR(v1); DIFINT_VAR(v2); DIFINT_VAR(v3); DIFINT_VAR(v4); DIFINT_VAR(v5);\
DIFINT_VAR(v6); DIFINT_VAR(v7); DIFINT_VAR(v8)

#define DIFINT_VAR_7(v1, v2, v3, v4, v5, v6, v7, v8, v9) \
DIFINT_VAR(v1); DIFINT_VAR(v2); DIFINT_VAR(v3); DIFINT_VAR(v4); DIFINT_VAR(v5);\
DIFINT_VAR(v6); DIFINT_VAR(v7); DIFINT_VAR(v8); DIFINT_VAR(v9)

#define DIFINT_VAR_7(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10) \
DIFINT_VAR(v1); DIFINT_VAR(v2); DIFINT_VAR(v3); DIFINT_VAR(v4); DIFINT_VAR(v5);\
